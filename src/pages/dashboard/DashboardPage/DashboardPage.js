        ...
        return (
          <div className="flex items-center justify-center min-h-screen">
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 max-w-md mx-auto text-center transition-colors duration-200"
            >
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Role Not Recognized</h3>
